...
public:
	...
	//to insert string's(s) character at given position(pos) as according to eer tree
	//After running this function , tree will have nodes of pssible palindromes till index pos
	...
	//Seconadry function to print all the possible palindromes in a given string
	...
	//Primary function to print all the possible palindromes in the given string
...
int main() {
    ...
    for(int i = 0; i < s.size(); ++i)
        tree.insert(s, i);
    //cout << "Insertion done\n";
    cout<<"All possible distinct Palindromes of given string are as :"<<"\n";
	tree.printAll(s);
}
